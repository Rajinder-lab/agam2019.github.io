    ...
    <div class="wrapper">
        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                //Check whether is uploaded button clicked or not
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        {
                            //Failed to upload
                            $_SESSION['upload'] = "<div class='error'>Failed to update new image.</div>";
                            //Redirect to manage food page
                            header('location:'.SITEURL.'admin/manage-food.php');
                            //Stop the process
                            die();
                        ...
                        if($current_image!="")
                        {
                            ...
                            if($remove==false)  
                            {
                                ...
                                $_SESSION['remove-failed'] = "<div class='error'>Failed to update new image.</div>";
                                //Redirect to manage food page
                                header('location:'.SITEURL.'admin/manage-food.php');
                                //Stop the process
                                die();                  
                ...
                //Rediredt to manage food with session message
